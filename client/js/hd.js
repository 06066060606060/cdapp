   ...
   */
    ...
    var tpicker2 = new timepicker(document.querySelector('input.timepicker'), args)

    /*
     *  Starts our Timepicker Functionality
     */
    function timepicker2(element, args) {
        ...
        this.buildString = function () {
            ...
            return (this.getHour() + ":" + this.getMinute() + ' ').trim()
    ...
    tpicker.updateSettings({ minTime: '2:00' })