  ...
  <div class="calendar--day-view" id="day-view">
    ...
    <div class="day-view-content">
      <div class="day-highlight">
       Vous <span class="day-events" id="day-events">n'avez pas travailler ce jour</span>. &nbsp; <span tabindex="0" onkeyup="if(event.keyCode != 13) return; this.click();" class="day-events-link" id="add-event" data-date>Ajouter un nouvel évenement?</span>
      </div>
